    ...
    public partial class AddToDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UIN = table.Column<string>(type: "nvarchar(15)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cars", x => x.UIN);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Car_UIN = table.Column<string>(type: "nvarchar(15)", nullable: false),
                    Driver_License = table.Column<string>(type: "nvarchar(15)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rented_Cars_Cars_Car_UIN",
                        column: x => x.Car_UIN,
                        principalTable: "Cars",
                        principalColumn: "UIN",
